...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_future_question(self):
        time = timezone.now()
        future_question = Question(pub_date=time + datetime.timedelta(days=5))
...
class QuestionIndexViewTests(TestCase):
    error_string = "There are no questions available yet."
    ...
    def test_now_questions(self):
        ...
        self.assertContains(response, self.error_string)
...
class QuestionDetailViewTests(TestCase):
    def test_future_question(self):
        ...
        url = reverse('my_app:detail', args=(future_question.id,))
